...
#include "AnimToolsFootstepModifier.generated.h"
...
UENUM()
enum class EFootstepDetectionTechnique : uint8
{
	/**
...
struct FFootstepDefinition
{
	...
	UPROPERTY(EditAnywhere, Category = "Sync Markers", meta=(EditCondition="bShouldGenerateSyncMarkers"))
	EFootstepDetectionTechnique SyncMarkerDetectionTechnique = EFootstepDetectionTechnique::PassThroughReferenceBone;

	UPROPERTY(EditAnywhere, Category = "Sync Markers", meta=(EditCondition = "SyncMarkerDetectionTechnique == EFootstepDetectionTechnique::FootBoneSpeed", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = "Notifies", meta=(EditCondition="bShouldGenerateNotifies"))
	TSubclassOf<UAnimNotify> FootstepNotify;
	
	// NEW: Add the Data Asset right into the definition!
	UPROPERTY(EditAnywhere, Category = "Notifies", meta=(EditCondition="bShouldGenerateNotifies"))
	TObjectPtr<UFootstepDataAsset> FootstepDataAsset = nullptr;

	UPROPERTY(EditAnywhere, Category = "Notifies", meta=(EditCondition="bShouldGenerateNotifies"))
	EFootstepDetectionTechnique FootstepNotifyDetectionTechnique = EFootstepDetectionTechnique::FootBoneSpeed;

	UPROPERTY(EditAnywhere, Category = "Notifies", meta=(EditCondition = "FootstepNotifyDetectionTechnique == EFootstepDetectionTechnique::FootBoneSpeed", EditConditionHides))
...
class ANIMTOOLS_API UAnimToolsFootstepModifier : public UAnimationModifier
{
...
public:
	...
	TArray<FFootstepDefinition> FootDefinitions;
...
private:
	...
	bool CanWePlaceEventAtSample(const FFootSampleState & InTestLegSampleState, EFootstepDetectionTechnique DetectionTechnique) const;
